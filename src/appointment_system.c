...
int patient_creation(long long int const *CPR){
    long long int internal_CPR;
    char first_name[32];
    char last_name[32];
    ...
    char buffer[64];
    sprintf(buffer,"id: %010lld,first_name: %s,last_name: %s",internal_CPR,first_name, last_name);
